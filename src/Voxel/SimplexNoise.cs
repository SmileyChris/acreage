...
/// <summary>
/// 2D simplex noise based on Stefan Gustavson's public-domain algorithm.
...
public static class SimplexNoise
{
    ...
    // Doubled permutation table to avoid index wrapping.
    private static readonly int[] P;

    // Gradient vectors for 2D simplex noise (12 directions).
    private static readonly float[][] Grad =
    {
